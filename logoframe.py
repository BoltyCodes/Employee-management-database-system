...
user = StringVar()
pwd = StringVar()
Label(mywin, text="Login Information", bg='purple', fg='pink', bd=5, font=('arial', 12, 'bold'), width=30).grid(
    columnspan=2)
...
Button(mywin, height=60, text="enter", width=120, command=login).grid(row=4, column=0)
Button(mywin, height=60, text="exit,", width=120, command=mywin.quit).grid(row=4, column=1)

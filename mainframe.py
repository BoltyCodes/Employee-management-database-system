...
def addEmployee():
    ...
    addForm.lift()
    Button(addForm, text="Save", command=lambda: saveRecord(enteno, entname, entdept, entsalary, addForm), width=10,
           bg='brown', fg='white', font=('verdana', 10, 'bold')).grid(row=5, column=0)
    Button(addForm, text="Clear", command=lambda: resetFields(eno, en, dp, sl, enteno), bg='brown', fg='white',
           font=('verdana', 10, 'bold'), width=10).grid(row=5, column=1)
    Button(addForm, text="Close Me!", command=addForm.destroy, width=20, bg='black', fg='white',
           font=('verdana', 10, 'bold')).grid(row=6, column=0, columnspan=2, pady=5)
...
def editEmployee():
    ...
    entsalary.grid(row=4, column=1, pady=10, sticky=W)
    editForm.lift()
    Button(editForm, text="Update", command=lambda: updateRecord(enteno, entname, entdept, entsalary, editForm),
           width=10, bg='brown', fg='white', font=('verdana', 10, 'bold')).grid(row=5, column=0)
    Button(editForm, text="Clear", command=lambda: resetFields(eno, en, dp, sl, enteno), bg='brown', fg='white',
           font=('verdana', 10, 'bold'), width=10).grid(row=5, column=1)
    Button(editForm, text="Close Me!", command=editForm.destroy, width=20, bg='black', fg='white',
           font=('verdana', 10, 'bold')).grid(row=6, column=0, columnspan=2, pady=5)
...
def deleteEmployee():
    ...
    entsalary.grid(row=4, column=1, pady=10, sticky=W)
    delForm.lift()
    Button(delForm, text="Update", command=lambda: deleteRecord(enteno, entname, entdept, entsalary, delForm), width=10,
           bg='brown', fg='white', font=('verdana', 10, 'bold')).grid(row=5, column=0)
    Button(delForm, text="Clear", command=lambda: resetFields(eno, en, dp, sl, enteno), bg='brown', fg='white',
           font=('verdana', 10, 'bold'), width=10).grid(row=5, column=1)
    Button(delForm, text="Close Me!", command=delForm.destroy, width=20, bg='black', fg='white',
           font=('verdana', 10, 'bold')).grid(row=6, column=0, columnspan=2, pady=5)
...
def searchEmployee():
    ...
    entsalary.grid(row=4, column=1, pady=10, sticky=W)
    searchForm.lift()
    Button(searchForm, text="Clear", command=lambda: resetFields(eno, en, dp, sl, enteno), bg='brown', fg='white',
           font=('verdana', 10, 'bold'), width=10).grid(row=5, column=1)
    Button(searchForm, text="Close Me!", command=searchForm.destroy, width=20, bg='black', fg='white',
           font=('verdana', 10, 'bold')).grid(row=6, column=0, columnspan=2, pady=5)
...
Button(mywin, text="Add New Employee", bg='yellow', fg='blue', font=('arial', 15, 'bold'), width=30,
       command=addEmployee).pack(pady=10)
Button(mywin, text="Edit Employee", bg='yellow', fg='blue', font=('arial', 15, 'bold'), width=30,
       command=editEmployee).pack(pady=10)
Button(mywin, text="Delete Employee", bg='yellow', fg='blue', font=('arial', 15, 'bold'), width=30,
       command=deleteEmployee).pack(pady=10)
Button(mywin, text="Search Employee", bg='yellow', fg='blue', font=('arial', 15, 'bold'), width=30,
       command=searchEmployee).pack(pady=10)
Button(mywin, text="Show All Employee", bg='yellow', fg='blue', font=('arial', 15, 'bold'), width=30,
       command=showAll).pack(pady=10)
Button(mywin, text="About Us", bg='yellow', fg='blue', font=('arial', 15, 'bold'), width=30, command=aboutUS).pack(
    pady=10)
Button(mywin, text="Exit", bg='yellow', fg='blue', command=mywin.quit, font=('arial', 15, 'bold'), width=30).pack(
    pady=10)
